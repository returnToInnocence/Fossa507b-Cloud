      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <div class="space-y-6">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="item in items" :key="item.id">
                <td class="px-2 py-4 whitespace-nowrap">
                  <div class="text-sm font-medium text-gray-900 text-center">{{ item.name }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-500 text-center">{{ item.description }}</div>
                </td>
                <td class="px-2 py-4 whitespace-nowrap text-center">
                  <button @click="goToDetail(item.id)" class="text-indigo-600 font-medium underline">
                    查看详情
                  </button>
                </td>
              </tr>
          ...
          <div class="mt-6 flex justify-center">
            <button @click="goToPublish" class="px-4 py-2 bg-indigo-600 text-white font-medium rounded-md">
              我要求助
            </button>
          </div>
        </div>
