        ...
        <div class="content">
            <div class="background-kanban vertical-center">
                <div class="left-inside round-corner vertical-center">
                    <h1>让你久等了</h1>
                    <div class="eris">
                        <img src="/src/img/ErisOVO.jpg" alt="signup-img" class="round-corner rotate">
                    </div>
                    <span>已有账号？快回去登录吧！</span>
                ...
                <div class="right-inside round-corner vertical-center">
                    <h1>507B欢迎你</h1>
                    <div class="eris">
                        <img src="/src/img/ErisOVO.jpg" alt="signup-img" title="Meow" class="round-corner rotate"
                            @click="Meow">
                    </div>
...
.login-wrap {
    /* background-image: url("../assets/photos/login2.jpg"); */
    width: 600px;
    height: 350px;
