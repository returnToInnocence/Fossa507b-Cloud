...
public class AcController {
    ...
    @PostMapping("/api/addExpTemp")
    public Object settemp(@RequestBody Map<String, Object> requestData) {
        String username = (String) requestData.get("temper");
        System.out.print("temper:");
        Integer temper = Integer.parseInt(username);
